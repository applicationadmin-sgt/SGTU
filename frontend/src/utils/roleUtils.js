/**
 * Utility functions for handling user roles in multi-role system
 */
 ...
 */
export function hasAnyRole(user, targetRoles) {
 ...
 */
export function hasAllRoles(user, targetRoles) {
  if (!user || !targetRoles || !Array.isArray(targetRoles)) return false;
 ...
 * 
 * @param {Object} user - The user object
 * @returns {boolean} - Whether the user is a dean
 */
 ...
 * 
 * @param {Object} user - The user object
 * @returns {boolean} - Whether the user is an HOD
 */
