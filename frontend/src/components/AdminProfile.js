        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ height: 'fit-content', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
            <CardContent sx={{ textAlign: 'center', p: 3 }}>
              ...
              <Chip 
                label={profile?.role?.toUpperCase() || 'ADMIN'}
                sx={{ 
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
                <Typography variant="h6" sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
                  <AccountBoxIcon sx={{ mr: 1, color: '#f44336' }} />
                  Contact Information
                </Typography>
                <Divider sx={{ mb: 2 }} />
                <List dense>
                ...
                <List dense>
                  <ListItem>
                    ...
                    <ListItemText 
                      ...
                      secondary="Full system administrator with all permissions" 
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText 
                      ...
                      secondary="Complete access to all schools, departments, and users" 
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText 
                      ...
                      secondary="Can create, modify, and delete all user accounts" 
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText 
                      ...
                      secondary="Full access to courses, videos, quizzes, and analytics" 
                    />
                  </ListItem>
                </List>
              </Paper>
