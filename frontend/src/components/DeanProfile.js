        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ height: 'fit-content', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
            <CardContent sx={{ textAlign: 'center', p: 3 }}>
              ...
              <Chip 
                label={profile?.role?.toUpperCase() || 'DEAN'}
                sx={{ 
        ...
        <Grid item xs={12} md={8}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
                <Typography variant="h6" sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
                  <AccountBoxIcon sx={{ mr: 1, color: '#9c27b0' }} />
                  Contact Information
                </Typography>
                <Divider sx={{ mb: 2 }} />
                <List dense>
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
                <Typography variant="h6" sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
                  <AdminIcon sx={{ mr: 1, color: '#9c27b0' }} />
                  Administrative Information
                </Typography>
                <Divider sx={{ mb: 2 }} />
                <List dense>
                  ...
                  {profile?.departments && (
                    <ListItem>
                      ...
                      <ListItemText 
                        primary="Departments" 
                        secondary={`${profile.departments.length || 0} department(s) under supervision`} 
                      />
                    </ListItem>
                  )}
