                    ...
                    <TableCell>
                      <Box>
                        <Typography variant="body2" color="error.main" fontWeight="bold">
                          ...
                          {item.unlockHistory?.admin?.some(a => a.overrideLevel === 'TEACHER') && (
                        ...
                        {item.lockInfo.hodUnlockCount > 0 && (
                          <Typography variant="caption" color="warning.main" display="block">
                            ...
                            {item.unlockHistory?.admin?.some(a => a.overrideLevel === 'HOD') && (
                              <Chip size="small" variant="outlined" color="secondary" label="Admin Override" sx={{ ml: 0.5, fontSize: '0.6rem', height: '16px' }} />
                            )}
                          </Typography>
                        )}
          ...
          {activeTab === 1 && (
            <>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                      <Button
                        ...
                        disabled={!filters.unitId && !filters.studentSearch && !filters.actionType}
                        sx={{ height: '40px' }}
                      >
                        Clear Optional Filters
                      </Button>
              ...
              {!filters.courseId || !filters.sectionId ? (
                <Box sx={{ textAlign: 'center', py: 8 }}>
                  ...
                  <Typography variant="h6" color="text.secondary" gutterBottom>
                    Select Course and Section to View HOD Dashboard
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
              ...
              {historyLoading ? (
                ...
                <Box sx={{ textAlign: 'center', py: 4 }}>
                  <Typography variant="body2" color="text.secondary">
                    No unlock history found. Unlocked quizzes will appear here.
                  </Typography>
                </Box>
              ) : (
                <>
                          ...
                          <TableRow key={idx} hover>
                            <TableCell>
                              <Box>
                                <Chip 
                                  size="small" 
                                  label={history.type === 'ADMIN_OVERRIDE' ? 'Admin Override' : history.type} 
                                  color={
                                    history.type === 'ADMIN_OVERRIDE' ? 'secondary' :
                                    history.type === 'HOD' ? 'warning' : 'primary'
                                  }
                                  sx={{ mb: 0.5 }}
                                />
                            ...
                            <TableCell>
                              ...
                              {history.type === 'ADMIN_OVERRIDE' && history.overrideLevel && (
                                <Typography variant="caption" color="secondary.main" sx={{ display: 'block' }}>
                                  Override: {history.overrideLevel} level
                                </Typography>
                              )}
                              {history.notes && (
