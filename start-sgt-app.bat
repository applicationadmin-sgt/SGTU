@echo off
echo 🚀 SGT Applicatecho HTTPS=true >> .env.development
echo HOST=192.168.7.20 >> .env.development
echo PORT=3000 >> .env.development Startup Script
echo.
...
echo 🌐 Frontend: http://192.168.7.20:3000
echo 🌐 Backend:  http://192.168.7.20:5000
goto :end
...
echo 🌐 Frontend: https://192.168.7.20:3000 (SECURE)
echo 🌐 Backend:  http://192.168.7.20:5000
goto :end
...
echo 🌐 Frontend: https://192.168.7.20:3000 (SECURE)
echo 🌐 Backend:  https://192.168.7.20:5000 (SECURE)
goto :end
...
echo - Certificates are valid for localhost, 127.0.0.1, and 192.168.7.20
